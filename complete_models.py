...
class TextModel(nn.Module):
    def __init__(self, vocab_size, cat_size, n_movies, args = None):
        ...
        self.base_model = args.Base_Model_Class(vocab_size = vocab_size, cat_size = cat_size, args = args)
        # self = self.cuda()
        # load base model
...
class FullAutoRec(TextModel):
    ...
    def forward(self, batch):
        ...
        sa_movie_vector = self.base_model.get_movie_ratings_vector(self.n_movies, sa_pred, batch_movie_mentions)
